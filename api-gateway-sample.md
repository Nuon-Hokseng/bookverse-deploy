...
snapshots:
  ...
  rate-limit-redis@4.2.2(express-rate-limit@8.0.1(express@5.1.0)):
    dependencies:
      express-rate-limit: 8.0.1(express@5.1.0)
  ...
  ts-node-dev@2.0.0(@types/node@24.3.0)(typescript@5.9.2):
    dependencies:
      chokidar: 3.6.0
      dynamic-dedupe: 0.3.0
      minimist: 1.2.8
...
### `api-gateway\src\types\express.d.ts`
...
### `api-gateway\src\utils\proxyHelpers.ts`
