...
const services = {
    ...
    books: {
        name: 'book-service',
        url: process.env.BOOK_SERVICE_URL || 'http://book-service:3000',
        healthCheck: '/api/books/health',
        requiresAuth: true, // Most book routes require authentication
        description: 'Book catalog and management service'
    },
    cart: {
        name: 'cart-service',
        url: process.env.CART_SERVICE_URL || 'http://cart-service:3001',
